...
createRegion('Asia','Sample Description', countryId : { countryName : 'India', language : 'Hindi', currency : 'Rupes',
 { stateName :'Andra', cityId :{ cityName: 'Tirupathi', cityDescription:'test purpose'}} );
